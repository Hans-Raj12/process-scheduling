 ...
 *
 */
public class FirstCome extends JFrame {
	...
	double d3;
	double d4;
	public FirstCome(double d1,double d2,double d3,double d4) {
	...
	private JPanel createChartPanel(double d1,double d2,double d3,double d4) {
		String chartTitle = "FIRST COME FIRST SERVE";
	...
	public CategoryDataset setValues (double d1,double d2 , double d3 , double d4)
	{
		...
		String series1 = "FIRST COME FIRST SERVE";
